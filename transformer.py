...
class TransformerNetwork(nn.Module):
    ...
    def __init__(self, input_channels=3, output_channels=3):
        ...
        self.ConvBlock = nn.Sequential(
            ConvLayer(input_channels, 32, 9, 1),
            nn.ReLU(),
            ConvLayer(32, 64, 3, 2),
            nn.ReLU(),
        ...
        self.DeconvBlock = nn.Sequential(
            ...
            nn.ReLU(),
            ConvLayer(32, output_channels, 9, 1, norm="None")
        )
...
class TransformerNetworkTanh(TransformerNetwork):
    ...
    def __init__(self, tanh_multiplier=150, input_channels=3, output_channels=3):
        super(TransformerNetworkTanh, self).__init__(input_channels, output_channels)
